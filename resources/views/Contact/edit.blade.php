                    ...
                    <div class="card-body">
                        <form action="/contact/{{ $contact->id }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" class="form-control" type="text" name="email" value="{{ $contact->email }}" required>
                                
                            </div> 
                            <div class="form-group">
                                <label for="number">Number</label>
                                <input id="number" class="form-control" type="text" name="number" value="{{ $contact->number }}" required>
                            </div>
                            <div class="form-group">
                                <label for="address">Address</label>
                                <input id="address" class="form-control" type="text" name="address" value="{{ $contact->address }}">
                            </div>
